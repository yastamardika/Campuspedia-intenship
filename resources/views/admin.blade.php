...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('paper/assets/img/logo campuspedia 2.png') }}">
  <link rel="icon" type="image/png" href="{{ asset('paper/assets/img/logo campuspedia 2.png') }}">
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
  <title>
    Administrasi Siswa Campuspedia
  </title>
      ...
      <div class="logo">
        <a href="http://www.creative-tim.com" class="simple-text logo-mini">
          <div class="logo-image-small">
            <img src="{{ asset('paper/assets/img/logo campuspedia 2.png') }}">
          </div>
        </a>
        <a href="https://campuspedia.id/kabar/" class="simple-text logo-normal">
          Campuspedia
        </a>
      </div>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="/">Student Management System Campuspedia</a>
          </div>
